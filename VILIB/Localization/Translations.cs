...
namespace VILIB.Localization
{
    ...
    {
        public static Delegate translate = GetTranslatedString;

        private static readonly Dictionary<string, Dictionary<string, string>> newTranslations =
            new Dictionary<string, Dictionary<string, string>>
            {
                ...
                },
                {
                    "EN", new Dictionary<string, string>
                    {
                        ...
                        {"unknown", "Unknown"},
                        {"warning", "VILIB"},
                        {"returnThisBook", "You took new book:"},
                        {"until", "Return until "},
                        {"tryAgain", "Try again"},
                        {"error", "Error"},
        ...
        public static string GetTranslatedString(string id)
        {
            ...
            var tempDictionary = newTranslations[StaticDataSource.CurrLanguage];
            if (tempDictionary.ContainsKey(id)) return tempDictionary[id];
            return "Bad string";
        }
    }
}