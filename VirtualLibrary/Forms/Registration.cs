...
namespace VirtualLibrary
{
    public partial class Registration : Form, IUser
    {
        ...
        private void NameTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(nameTextBox.Text)) _nameErrorProvider.SetError(nameTextBox, "empty");
        }
        ...
        {
            var inputValidator = new InputValidator();
            if (string.IsNullOrEmpty(usernameTextBox.Text)) _surnameErrorProvider.SetError(usernameTextBox, "empty");
        ...
        private void SurnameTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(surnameTextBox.Text))
                _surnameErrorProvider.SetError(surnameTextBox, "empty");
            else
